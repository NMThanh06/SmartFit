                    ...
                    <div class="cart-shop-products" style="padding: 12px;">
                        ${group.items.map(item => `
                            <div class="cart-item" style="display: flex; gap: 12px; align-items: flex-start;">
                                <img src="${item.image}" alt="${item.name}" style="width: 65px; height: 80px; object-fit: cover; border-radius: 8px; flex-shrink: 0;" onerror="this.src='/assets/img/default-placeholder.jpg'">
