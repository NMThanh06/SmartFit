...
try {
    ...
    $orderSql = "INSERT INTO orders (id, user_id, shop_id, fullname, phone, address, note, payment_method, payment_status, total_amount) 
                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $orderStmt = mysqli_prepare($conn, $orderSql);
    mysqli_stmt_bind_param($orderStmt, "siissssssi", $orderId, $userId, $shopId, $fullname, $phone, $address, $note, $payment_method, $payment_status, $totalAmount);
